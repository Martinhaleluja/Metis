...
public static class AnnotationDuration
{
    ...
    /// </summary>
    public static readonly TimeSpan Standard = GuidanceTuning.Scale(TimeSpan.FromSeconds(14));
    ...
    /// </summary>
    public static readonly TimeSpan Small = GuidanceTuning.Scale(TimeSpan.FromSeconds(9));
