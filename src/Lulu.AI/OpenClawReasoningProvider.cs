...
/// OpenClaw plans work; Lulu remains the only component that executes desktop input.
/// </summary>
public sealed class OpenClawReasoningProvider : IReasoningProvider, IDisposable
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var payload = JsonSerializer.Serialize(new
        {
            ...
            instructions = ReasoningProviderSupport.SystemInstruction,
            input = new[]
            {
                new
                {
        ...
        string? credential)
    {
        ...
        return statusCode switch
        {
            ...
            HttpStatusCode.BadRequest => ReasoningProviderSupport.Error(
                ...
                $"OpenClaw rejected Lulu's request or agent model '{model ?? "requested"}'. {detail}",
                status),
